    ...
    <div className="relative p-4 border rounded-lg shadow-lg bg-white max-w-sm w-full sm:max-w-md">
      ...
      <div
        className={`relative cursor-pointer overflow-hidden rounded-lg ${
          isFullScreen ? "fixed inset-0 bg-black flex justify-center items-center" : ""
        }`}
      ...
      <button onClick={handleDownload} className="mt-4 w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600">
        ⬇ Download
      </button>
    </div>
  );
