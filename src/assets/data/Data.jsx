import CheeseFries from "../data/Snacks/Cheese Fries.jpg";
import CheeseJalapenoPeppers from "../data/Snacks/Cheese Jalapeno Peppers.jpg";
import CheesePotatoPops from "../data/Snacks/Cheese Potato Pops.jpg";
import CornCheeseNuggets from "../data/Snacks/Corn Cheese Nuggets.jpg";
import CreamHerbSeasonedFries from "../data/Snacks/Cream & Herb Seasoned Fries.jpg";
import FrenchFries from "../data/Snacks/French Fries.jpg";
import HaraBharaKabab from "../data/Snacks/HaraBharaKabab.jpg";
import PiriPiriFrenchFries from "../data/Snacks/Piri Piri French Fries.jpg";
import PotatoWedges from "../data/Snacks/Potato Wedges.jpg";
import SamosaPaneerSamosa from "../data/Snacks/Samosa,Paneer Samosa.jpg";
import TandooriPaneerNuggets from "../data/Snacks/Tandoori Paneer Nuggets.jpg";
import VegSpringRolls from "../data/Snacks/Veg Spring Rolls.jpg";

import BlackCurrentShake from "../data/Drinks/Black Current Shake.jpg";
import Fruitpanch from "../data/Drinks/Fruit panch.jpg";
import LeechiShake from "../data/Drinks/Leechi Shake.jpg";
import OrangeBlossom from "../data/Drinks/Orange Blossom.jpg";
import SoftDrinks from "../data/Drinks/Soft Drinks.jpg";
import StrawberryMilkShake from "../data/Drinks/Strawberry Milk Shake.jpg";

import Bhelpuri from "../data/Fast Food/Bhel Puri.jpg";
import CholeBhature from "../data/Fast Food/Chole Bhature.jpg";
import Dabeli from "../data/Fast Food/Dabeli.jpg";
import Dosa from "../data/Fast Food/Dosa.jpg";
import Idli from "../data/Fast Food/Idli.jpg";
import Manchuriyan from "../data/Fast Food/Manchuriyan.jpg";
import Momos from "../data/Fast Food/Momos.jpg";
import Pakoras from "../data/Fast Food/Pakoras.jpg";
import PaniPuri from "../data/Fast Food/Pani Puri.jpg";
import Pavbhaji from "../data/Fast Food/Pav bhaji.jpg";
import VadaPav from "../data/Fast Food/Vada Pav.jpg";

import CornPeasSandwich from "../data/Sandwiches/Corn & Peas Sandwich.jpg";
import GrilledSandwich from "../data/Sandwiches/Grilled Sandwich.jpg";
import PaneerGrilledSandwich from "../data/Sandwiches/Paneer Grilled Sandwich.jpg";

import ChillyGarlic from "../data/Noodals/Chilly Garlic Noodles.jpg";
import HakkaNoodles from "../data/Noodals/Hakka Noodles.jpg";
import HongKongNoodles from "../data/Noodals/Hong Kong Noodles.jpg";
import ManchurianNoodles from "../data/Noodals/Manchurian Noodles.jpg";
import SchezwanNoodles from "../data/Noodals/Schezwan Noodles.jpg";
import SingapureNoodles from "../data/Noodals/Singapure Noodles.jpg";
import TripleNoodles from "../data/Noodals/Triple Noodles.jpg";

import AchariPaneer from "../data/Paneer Specail/Achari Paneer.jpg";
import ChilliPaneer from "../data/Paneer Specail/Chilli Paneer.jpg";
import KadhaiPaneer from "../data/Paneer Specail/Kadhai Paneer.jpg";
import MatarPaneer from "../data/Paneer Specail/Matar Paneer.jpg";
import PalakPaneer from "../data/Paneer Specail/Palak Paneer.jpg";
...
import FruitSalad from "../data/Dessert/Fruit Salad.jpg"
import FruitSkewers from "../data/Dessert/Fruit Skewers.jpg"
import GajarHalwa from "../data/Dessert/Gajar Halwa.jpg"
import GulabJamun from "../data/Dessert/Gulab Jamun.jpg"
import Jalebi from "../data/Dessert/Jalebi.jpg"
import Rashmalai from "../data/Dessert/Rashmalai.jpg"

import BesanBurfi from "../data/Sweets/Besan Burfi.jpg"
import BikanerBurfi from "../data/Sweets/Bikaner Burfi.jpg"
import CharBadam from "../data/Sweets/Char Badam.jpg"
import Chenamurgi from "../data/Sweets/Chena murgi.jpg"
import ChocolateBurfi from "../data/Sweets/Chocolate Burfi.jpg"
import ChocolateBadam from "../data/Sweets/Chocolate Badam.jpg"
import ChocolateRoll from "../data/Sweets/Chocolate Roll.jpg"
import CoconutBurfi from "../data/Sweets/Coconut Burfi.jpg"
import Coconutladdu from "../data/Sweets/Coconut laddu.jpg"
import DodaBurfi from "../data/Sweets/Doda Burfi.jpg"
import KajuBarfi from "../data/Sweets/Kaju Barfi.jpg"
import kalakand from "../data/Sweets/kalakand.jpg"
import KhoyaPakija from "../data/Sweets/Khoya Pakija.jpg"
import KhoyaRoll from "../data/Sweets/Khoya Roll.jpg"
import LalPeda from "../data/Sweets/Lal Peda.jpg"
import MathuraPeda from "../data/Sweets/Mathura Peda.jpg"
import Milkcake from "../data/Sweets/Milk cake.jpg"
import PaanPetha from "../data/Sweets/Paan Petha.jpg"
import PistaBurfi from "../data/Sweets/Pista Burfi.jpg"
import PlainBurfi from "../data/Sweets/Plain Burfi.jpg"
import Rabadi from "../data/Sweets/Rabadi.jpg"
import Safedpeda from "../data/Sweets/Safed peda.jpg"
